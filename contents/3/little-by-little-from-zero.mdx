...
description: Let's start everything from scratch, accumulate little by little from zero, from small success.
slug: little-by-little-from-zero
date: "2021-08-01"
---

There is a video on <CoolText>[Youtube](https://www.youtube.com/watch?v=n_0iPFzkNaQ)</CoolText>
...
If we feel alone we need to _challenge_ -> _effort_ -> _finish_ something.

### At the moment

Sometimes we feel bored and we always remember the past and imagine something in the future. 
According to the author, we will lose important time, we need to _live at the moment_.
